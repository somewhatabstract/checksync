...
import type {MarkerCache} from "./types.js";
 ...
 */
export async function fromFiles(files: Array<string>): Promise<MarkerCache> {
    ...
    for (const file of files) {
        cacheData[file] = await parseFile(file, true, logFileRef);
    }
    ...
    for (const fileRef of _.uniq(referencedFiles)) {
        ...
        cacheData[fileRef] = await parseFile(fileRef, false);
    }
